...
export default function CardTestimonials(props:any) {
  return (
    <div>
        <div className="group w-full bg-white relative flex flex-col items-center hover:bg-indigo-700 cursor-pointer shadow-md md:p-12 p-6">
            <div className="text-gray-600 group-hover:text-white flex flex-col items-center">
                ...
                <p className="xl:w-80 text-base leading-normal text-center mt-4">{props.testimonial}</p>
            </div>
        ...
        <div className="flex flex-col items-center justify-center mt-10">
            <Image 
                    ...
                    alt="avatar"
                />
            <p className="text-base font-semibold leading-4 my-2 text-gray-800">{props.name}</p>
            <p className="text-base leading-4 text-center text-gray-600">{props.title}</p>
        </div>
    </div>
  )
}
